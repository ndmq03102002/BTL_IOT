...
function controlLed(ledCommand, onCallback, offCallback, onCountElement, offCountElement) {
    ...
    fetch("http://localhost:8080/led", requestOptions)
        .then(data => {
            ...
            document.getElementById(onCountElement).innerText = ledCommand.startsWith("onled1") ? onLed1Count : onLed2Count;
            document.getElementById(offCountElement).innerText = ledCommand.startsWith("onled1") ? offLed1Count : offLed2Count;
