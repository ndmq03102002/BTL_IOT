...
function warning() {
  if (countGas >= 70) {  
    ...
    box5.classList.add('warning');
    box6.classList.add('warning');
    box7.classList.add('warning');
  } else {
    box1.classList.remove('warning');
    box2.classList.remove('warning');
    box3.classList.remove('warning');
    box4.classList.remove('warning');
    box5.classList.remove('warning');
    box6.classList.remove('warning');
    box7.classList.remove('warning');
  }
}
...
document.querySelector(".onLed3").addEventListener("click", function() {
  controlLed("onled3", OnLight, OffLight);
});

document.querySelector(".offLed3").addEventListener("click", function() {
  controlLed("offled3", OnLight, OffLight);
});
