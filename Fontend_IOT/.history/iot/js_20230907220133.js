...
function changeTemp() {
  if (countTemp <= 10) {
    ...
    box1.style.background = "#3fc848";
  } else if (countTemp <= 35) {
    box1.style.background = "#c8b83f";
  } else {
    box1.style.background = "#c83f3f";
  }
  if (countTemp > 50) {
...
function changeHum() {
  if (countHum <= 10) {
    box2.style.background = "#9fb4d0";
  } else if (countHum <= 25) {
    box2.style.background = "#3fc848";
  } else if (countHum <= 35) {
    box2.style.background = "#c8b83f";
  } else {
    box2.style.background = "#c83f3f";
  }
  if (countHum > 50) {
    box2.style.background = "#fd0606";
  }
}
