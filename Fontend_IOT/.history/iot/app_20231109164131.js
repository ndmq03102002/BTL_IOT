...
// Để lấy tổng số lần, bạn có thể sử dụng các biến đếm đã khai báo
console.log("Tổng số lần onled1: " + onLed1Count);
console.log("Tổng số lần offled1: " + offLed1Count);
console.log("Tổng số lần onled2: " + onLed2Count);
console.log("Tổng số lần offled2: " + offLed2Count);
