...
let dataFromSpringBoot = []
   function getTempAllData(){
        ...
        return fetch(`http://localhost:9000/Iot/getAllData`)
...
function displayData(data) {
    ...
    data.forEach(rowData => {
        ...
        row.innerHTML = `<td>${rowData.id}</td><td>${rowData.temperature}</td><td>${rowData.humidity}</td><td>${rowData.light}<td>${rowData.time}</td></td>`;
