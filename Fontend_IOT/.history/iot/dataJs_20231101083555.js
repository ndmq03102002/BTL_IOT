...
getTempAllData().then(() => {
  ...
  button_sort_light_incre = document.querySelector("#sort-by-gas-incre").addEventListener('click',()=>{
      DataSort = SortIncrease("gas")
      let totalPages = Math.ceil(DataSort.length/10); 
      let currentPage = 1;
      displayPage(currentPage,DataSort)
      updatePaginationUI(totalPages,currentPage,DataSort);
  ...
  button_sort_light_incre = document.querySelector("#sort-by-gas-decre").addEventListener('click',()=>{
      DataSort = SortDecrease("gas")
      let totalPages = Math.ceil(DataSort.length/10); 
      let currentPage = 1;
      displayPage(currentPage,DataSort)
      updatePaginationUI(totalPages,currentPage,DataSort);
