...
// }   
    ...
    // setInterval(getTempAllData,1000)
// const AllTempData = []
...
//     });
function OnFan(){
    const blade1 = document.querySelector(".blade-1").style.animation="rotateFan1 1s linear infinite";
    const blade2 = document.querySelector(".blade-2").style.animation="rotateFan2 1s linear infinite";
    const blade3 = document.querySelector(".blade-3").style.animation="rotateFan3 1s linear infinite";
}
function OffFan(){
